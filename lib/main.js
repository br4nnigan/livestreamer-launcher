...
czxzyyyk.livestreamer = function init() {
	...
	const ID_QUALITY = "extentions.czxzyyyk.livestreamer.quality";
	const ID_CONTEXTMENU = "extentions.czxzyyyk.livestreamer.contextmenu";
	...
	id: ID_CONTEXTMENU,
	type: "normal",
	contexts: ["link", "selection", "page", "tab"]
	}, onCreated);
	...
	function onCreated() {
		 if (browser.runtime.lastError) {
			...
			console.log("Item created successfully", arguments);
		}
	}
	...
	function runLivestreamer(streamUrl){
		...
		var gettingItem = browser.storage.local.get(ID_QUALITY),
			quality;
		gettingItem.then((res) => {
			quality = res.colour || "best";
		});
		var qualities = {
			"youtube": {
				"best": "best",
